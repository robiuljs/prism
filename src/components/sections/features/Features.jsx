        ...
        <section className="innovation-section relative z-20">
            <div className="container flex flex-col justify-center md:gap-y-[76px] sm:gap-y-12 gap-y-8">
                ...
                <div className="innovation-card-wrapper max-w-[1092px] mx-auto w-full flex flex-col gap-[13px]">
                    ...
                    {/* --- CARD ONE --- */}
                    <div className="w-full flex sm:flex-row flex-col-reverse gap-5 items-center justify-between bg-gradient-to-t from-white/5 to-black/90 rounded-[40px] lg:py-[50px] lg:px-[65px] py-6 px-6">
                    ...
                    {/* --- CARD TWO --- */}
                    <div className="w-full flex sm:flex-row flex-col-reverse gap-5 items-center justify-between bg-gradient-to-t from-white/5 to-black/90 rounded-[40px] lg:px-[65px] px-6 md:py-0 py-5">
                    ...
                    <div className="feature-grid">
                        ...
                        {/* --- CARD SIX --- */}
                        <div className="feature-grid-4 w-full flex sm:flex-row flex-col-reverse gap-5 items-center justify-between gap-y-10 bg-gradient-to-t from-white/5 to-black/90 rounded-[20px] py-[40px] px-[34px]">
